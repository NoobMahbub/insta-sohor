/*bugs:
1. heart button color not working in post - Done 
2. fix user profile pic in post - Done
3. if post character is > 30 then we will show read more or we need to show all text - Done
4.  comment is undefined: {comment user, comment} - Done
5.  show only reported post in report area - Done
6. liked photo repeat off - Done
*/
